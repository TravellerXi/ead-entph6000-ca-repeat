...
> "Three technologies not taught in this module: Argo CD, RabbitMQ and KEDA. I screened all 28 lecture and lab documents, the 22 supplied manifests and every lecture transcript from Weeks 1 to 11, including the Week 2 guest material. Only one of the sixteen recordings carried captions; I transcribed eight more myself with a local speech-to-text model, and for the remaining seven I read the same-week slides instead. Argo CD and KEDA appear nowhere at all. RabbitMQ appears once — as an unexplained dependency inside the Week 3 AKS sample manifest — but messaging is never taught or assessed, so the design here is my own. I originally planned Prometheus and Grafana and rejected them, because Week 10 covers both and they would have scored zero."
